...
def yolo_predict_simple(image_path, model_path, conf_threshold=0.5, iou_threshold=0.45):
    ...
    # Dự đoán - TRUYỀN ĐƯỜNG DẪN ẢNH VÀ ÁP DỤNG NMS
...
if __name__ == "__main__":
    ...
    # Điều chỉnh conf_threshold và iou_threshold để kiểm soát NMS
    # conf_threshold: Chỉ giữ các predictions có confidence > ngưỡng này
    # iou_threshold: NMS - nếu IOU > ngưỡng này thì xóa box có confidence thấp hơn
    yolo_predict_simple(
        image_path,
        model_path,
